...
# Configuração inicial da página (Garante que a interface carregue sempre)
...
# 🛡️ ISOLAMENTO DE DEPENDÊNCIAS: Carrega os módulos compartilhados de forma segura
try:
    import docx
    ...
    st.error(f"⚠️ Aguarde o carregamento das dependências compartilhadas do repositório no servidor. Detalhe técnico: {str(e)}")
    BIBLIOTECA_OK = False
...
if BIBLIOTECA_OK:
    ...
    # ============================================================
    # 🎨 ENGINE DE FORMATAÇÃO (ESTRITO CALIBRI)
    # ============================================================
