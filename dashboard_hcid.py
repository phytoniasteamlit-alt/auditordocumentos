...
# ==============================================================================
# 3. MOTOR DE PROCESSAMENTO ISOLADO POR ÍNDICE FÍSICO DE ABA
# ==============================================================================
...
# ==============================================================================
# 4. EXECUÇÃO DO PROCESSAMENTO EM ABAS TOTALMENTE ISOLADAS
# ==============================================================================
if uploaded_file is not None:
    excel_file = pd.ExcelFile(uploaded_file)
    abas_planilha = excel_file.sheet_names
    
    # df_hcid mapeia estritamente a aba 1 (índice 0), df_anexos mapeia estritamente a aba 2 (índice 1)
    ...
    # --------------------------------==========================================
    # GUIA 1: CONTEÚDO EXCLUSIVO DO HOSPITAL GERAL (HCID)
    # --------------------------------==========================================
    with tab_hcid:
        ...
        if not df_hcid.empty:
            ...
            c3.metric("☀️ Total de vagas do turno manhã (HCID)", f"{t_m_h} M")
            c4.metric("🌙 Total de vagas do turno tarde (HCID)", f"{t_t_h} T")
